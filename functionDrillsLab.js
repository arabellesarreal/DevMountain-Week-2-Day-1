...
//CODE HERE
function greeting(perName){
  console.log(`Hello, ${perName}`)
}
greeting(personName)
////////////////// PROBLEM 5 ////////////////////
...
console.log(exclaimThree("String"))
...
*/
let email = "test email @ gmail.com"
...
//CODE HERE
let gold = 37
function chocoFrogs(goldNum){
  let totalFrogs = goldNum/3
  return totalFrogs
}
...
function chocoFrogs2(goldNum){
  let totalFrogs = goldNum/3
  return parseInt(totalFrogs2)
}
...
//CODE HERE
function ascendingList(arrayIsAscending){
  for(let i = 0; i < arrayIsAscending.length; i++){
...
console.log(ascendingList(sampleArray))
